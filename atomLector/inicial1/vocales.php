...
.colorfulForm button{
  ...
  border-style: none;
      ...
      <div class="col-md-8 col-xs-8 pag-center">
        ...
        <h1 style="margin-top: 50px;">Práctica Fonemas</h1>


          <div>
            <h3>Esta  actividad se habilitará en próximas fechas </h3>
             <img src="../../img/trabajando.jpg" class="col-md-12" height="550px;"> 
