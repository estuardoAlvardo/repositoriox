  ...
  .skew.r {
    ...
    transform: skew(00deg,-40deg);
      ...
      <div class="col-md-10 col-xs-10 pag-center">
         ...
         <a href="<?php echo '../lecturasDiarias.php?gradoB='.$_GET['gradoB']; ?>" style="background-color: #e67e22; border:1px solid #e67e22; color:white; "></a>
...
<div class="row sectionDinamico masCentrado" style="margin-bottom: 280px;">
           <div class="col-md-11">
...
<form id="formularioDiariasPresco" method="post" action="controllador/lecturasDiariasPresco.php">
