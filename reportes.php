         ...
         <div class=" col-xs-12" style="height:50px; margin-bottom: 50px;">
             <form method="get" action="reportes.php" class="form-inline form-filtro " id="formulario">
                  ...
                  <div class="form-group" >
                   ...
                   <div class="form-group" >
                    <label class="sr-only" for="filtro-tipo">Carrera</label>
                
                    <select class="form-control" name="seccion" id="seccion" style="margin-left: 20px; <?php echo $diver1; ?>" >
                         <option value="a" selected>Carrera</option>
                        <option value="a">Ciencias y Letras</option>
                        <option value="b">Bachillerato en computación</option>
                        <option value="c">Bachillerato en diseño</option>                        
...
switch ($gradoReporte) {
  ...
  case 10:
    ...
    switch ($seccion) {
      case 'a':
       $carreraDiseño='Ciencias y Letras';
        break;
      case 'b':
       $carreraDiseño='Bachillerato en computación';
        break;
      case 'c':
       $carreraDiseño='Bachillerato en diseño';
        break;
 ...
 <div class="col-md-2 sombra text-left" style="height:25px; margin-top:50px; margin-bottom: -170px; background-color: #2980b9; color: white; border-radius: 5px;">Lecturas Diarias</div>
          ...
          <div class="col-md-12 sombra"  id="customers" style=" min-height:100px; margin-bottom: 30px;">
                    ...
                    <table class="table table-hover" id="lectDiaria">
                       <caption style="display: none;"><?php echo 'Grado: '.$gradoDiseño.'<br> Carrera: '.$carreraDiseño.' <br>  Semana: '.$semana.'<br> Reporte a fecha: '.$fecha_actual.' '.$hora_actual;  ?></caption>
                      <thead>
   ...
   <?php }else{ ?>
     ...
     <div class="col-md-2 sombra text-left" style="height:25px; margin-top:50px; margin-bottom: -170px; background-color: #2980b9; color: white; border-radius: 5px;">Lecturas Diarias</div>
           ...
           <h2 class="sombra "  style="display: block; margin-top: 100px; border-radius: 5px; padding: 5px; text-align: left;"><?php echo 'Grado: '.$gradoDiseño.'<br> Carrera: '.$carreraDiseño.' <br>  Semana: '.$semana.'<br> Reporte a fecha: '.$fecha_actual.' '.$hora_actual;  ?></h2>
          <div class="col-md-12 sombra"  id="customers" style=" min-height:100px; margin-bottom: 30px;">
...
<div class="col-md-3 sombra text-left" style="height:25px; margin-bottom: 15px; background-color:#1abc9c; color: white; border-radius: 5px;">Lecturas De Medición</div>
          ...
          <div class="col-md-12 sombra" style=" min-height:100px;  margin-bottom: 50px; overflow: auto; ">
                    ...
                    <table class="table table-hover" id="lecturasMedicion">
                       <caption style="display: none;"><?php echo 'Grado: '.$gradoReporte.'Carrera '.$carreraDiseño.'-- Semana '.$semana.'<br> Reporte a fecha: '.$fecha_actual.' '.$hora_actual; ; ?></caption>
                        <thead>
                        <tr>
                          <th scope="col">Alumno</th>
                          ...
                          <td>
                           ...
                           //consulta para ver cuantas palabras lleva
                              ...
                              if($totalRegistro>=1){
                               ...
                               echo rount($porcentajeRealizado).'%';
