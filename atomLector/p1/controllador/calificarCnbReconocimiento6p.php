...
$sq1 = ("SELECT *  FROM atomolector as lectura join cuestionario as cues on lectura.idLectura=cues.idLectura join itemopcionmultiple as item on item.idCuestionario=cues.idCuestionario where lectura.idLectura=:idLectura AND fundamento=:fundamento");
    $kbtenerCuestionario = $dbConn->prepare($sq1);
     $kbtenerCuestionario->bindparam(':idLectura',$_POST['idLecturaEnviado'],PDO::PARAM_INT);
     $kbtenerCuestionario->bindparam(':fundamento', $fundamento,PDO::PARAM_STR);
    $kbtenerCuestionario->execute();
    $hayItems=$kbtenerCuestionario->rowCount();

//preparamos sql para insertar

$sql2 = ("INSERT INTO registropruebacomprension6p(idLectura,idUsuario,tiempo,fechaRegistro,horaRegistro,rPregunta1,rPregunta2,rPregunta3,rPregunta4,rPregunta5,rPregunta6,rPregunta7,rPregunta8,rPregunta9,rPregunta10,rPregunta11,rPregunta12,rPregunta13, input1,input2,input3,input4,totalObtenido,intento) VALUES (:idLectura,:idUsuario,:tiempo,:fechaRegistro,:horaRegistro,:rPregunta1,:rPregunta2,:rPregunta3,:rPregunta4,:rPregunta5,:rPregunta6,:rPregunta7,:rPregunta8,:rPregunta9,:rPregunta10,:rPregunta11,:rPregunta12,:rPregunta13,:input1,:input2,:input3,:input4,:totalObtenido,:intento)");
$insertarQuiz6p = $dbConn->prepare($sql2);


//verificar intentos
$sql3=('SELECT * FROM registropruebacomprension6p where idLectura=:idLectura and idUsuario=:idUsuario');
...
foreach($_POST as $nombre_campo => $valor){ 
   ...
   if($nombre_campo=='idLecturaEnviado'){
      ...
      $insertarQuiz6p->bindParam(':idLectura',$_SESSION['idLectura_g'], PDO::PARAM_INT);
   }

   if($nombre_campo=='idUsuario'){
     $_SESSION['idUsuario_g']=$valor; 
     $insertarQuiz6p->bindParam(':idUsuario',$_SESSION['idUsuario_g'], PDO::PARAM_INT);

   }

   if($nombre_campo=='tiempo'){
    $_SESSION['tiempo_g']=$valor; 
     $insertarQuiz6p->bindParam(':tiempo', $_SESSION['tiempo_g'], PDO::PARAM_STR);

   }

   $insertarQuiz6p->bindParam(':fechaRegistro', $fecha_actual, PDO::PARAM_STR);
   $insertarQuiz6p->bindParam(':horaRegistro', $hora_actual, PDO::PARAM_STR);
  ...
  if(strpos($nombre_campo, 'multiple')!== false){
    ...
    //echo $insertar;
      ...
      if($insertar1=='rPregunta1'){
        ...
        $_SESSION['oki1']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['oki1'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta2'){
         $_SESSION['new1']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['new1'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta3'){
        $_SESSION['lem1']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['lem1'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta4'){
        $_SESSION['almacenar4']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar4'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta5'){
        $_SESSION['almacenar5']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar5'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta6'){
        $_SESSION['almacenar6']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar6'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta7'){
        $_SESSION['almacenar7']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar7'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta8'){
        $_SESSION['almacenar8']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar8'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta9'){
        $_SESSION['almacenar9']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar9'], PDO::PARAM_INT);
      ...
      if($insertar1=='rPregunta10'){
        $_SESSION['almacenar10']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar10'], PDO::PARAM_INT);
         //echo 'pregunta= '.$insertar1.' respuesta= '.$_SESSION['almacenar9'].'<br>';
       ...
       if($insertar1=='rPregunta11'){
        $_SESSION['almacenar11']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar11'], PDO::PARAM_INT);
         //echo 'pregunta= '.$insertar1.' respuesta= '.$_SESSION['almacenar9'].'<br>';
      ...
      if($insertar1=='rPregunta12'){
        $_SESSION['almacenar12']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar12'], PDO::PARAM_INT);
         //echo 'pregunta= '.$insertar1.' respuesta= '.$_SESSION['almacenar9'].'<br>';
      ...
      if($insertar1=='rPregunta13'){
        $_SESSION['almacenar13']=$valor;
         $insertarQuiz6p->bindParam($insertar1, $_SESSION['almacenar13'], PDO::PARAM_INT);
         //echo 'pregunta= '.$insertar1.' respuesta= '.$_SESSION['almacenar9'].'<br>';
   ...
   //echo $insertar;
    ...
    //echo 'pregunta '.$insertar.'-----Respuesta ya comparada---'.$_SESSION['resultado'.$k].'<br>';
     ...
     $insertarQuiz6p->bindParam(':intento', $hayIntentos, PDO::PARAM_INT);

   }

   }
   echo 'totalObtenido = '.@$sumaCorrectas;
   

   $insertarQuiz6p->bindParam(':totalObtenido', $sumaCorrectas, PDO::PARAM_INT);

$insertarQuiz6p->execute();
header("location:../resultadoCnb6p.php?idLectura=".$_POST['idLecturaEnviado']."&idUsuario=".$_POST['idUsuario'].'&gradoB='.$_POST['gradoB']);
