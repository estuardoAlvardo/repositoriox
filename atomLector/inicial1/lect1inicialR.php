...
<div class="container1 one">
           ...
           <hr>
              ...
              <a  href="pruebaC.php?noLectura=<?php echo $row1['idLectura']; ?>" class="btn align-center botonAgg-1" style="margin-left: 45%;color: white; background-color:#3498db; ">Prueba Comprensión</a>
              ...
              <hr>
              <audio controls  style="border-radius: 25px; margin-left: 45%;" class="cajaDescripcion">
               ...
               <a href="<?php echo '../lecturasDiarias.php?gradoB='.$_GET['gradoB']; ?>" class="btn btn-default botonAgg-1" style="margin-left:15px;background-color: #e67e22; border:1px solid #e67e22; color:white; ">volver a las lecturas diarias</a>
...
<div class="magazine-viewport " >
 ...
 <div  class="col-md-12 cajaDescripcion" style="margin-top: 50px;" >
