         ...
         <div class="col-md-12" style="margin-top: 60px;">
          <?php while(@$row1=$mostrarLectura->fetch(PDO::FETCH_ASSOC)){   
            ...
            ?>
              ...
              <a href="glosario.php?noLectura=<?php echo $row1['idLectura']; ?>&gradoB=<?php echo $_GET['gradoB']; ?>" class="btn align-center botonAgg-1" style="color: white; background-color:#ff4757; ">3) Mi vocabulario</a>
               <a href="cuentame.php?noLectura=<?php echo $row1['idLectura']; ?>&gradoB=<?php echo $_GET['gradoB']; ?>" class="btn align-center botonAgg-1" style="color: white; background-color:#e67e22; ">4) Con tus palabras</a>
              <a href="personajes.php?noLectura=<?php echo $row1['idLectura']; ?>&gradoB=<?php echo $_GET['gradoB']; ?>" class="btn align-center botonAgg-1" style="color: white; background-color:#f1c40f; margin-top: 10px; ">5) Identificar Personaje</a>
              <hr>
         </div>
