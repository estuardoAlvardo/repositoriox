...
<div class="col-md-11" style="margin-bottom: 100px;"><br><br>
  ...
  <div class="col-md-12 cajaGrado" style="min-height: 200px;">
     ...
     <a href="" style="color: white; <?php echo $presco1; ?>"><div class="col-md-2 btnGrado">Pre-Kinder</div></a>
    <div class="col-md-1"></div>
    <a href="" style="color: white;  <?php echo $presco2; ?>" ><div class="col-md-2 btnGrado" style="">Kinder</div></a>
    <div class="col-md-1"></div>
    <a href="" style="color: white;  <?php echo $presco3; ?>"><div class="col-md-2 btnGrado"  style="">Preparatoria</div></a>
    <div class="col-md-1"></div>
    </div>
    <p>Primaria</p>
  <div class="row" style="padding-left: 40px;">
