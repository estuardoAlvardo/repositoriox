...
<?php 
    ...
    $qnew=("SELECT DISTINCT semana,semanaMaestro from atomolector where grado=:grado and semana IS NOT NULL");
  ...
  <div class="container">
      ...
      <div class="col-sm-9">
          ...
          <div class="page-header" >
            <h3>Semana <?php echo $contador; echo ' '.$mostSemana['semanaMaestro']; ?>  </h3>
          </div>
