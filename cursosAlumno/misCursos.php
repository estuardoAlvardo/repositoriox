...
//validacion grados fonemas
if($_SESSION['grado']>=13 and $_SESSION['grado']<=15){
  $linkVelocidad='../atomLector/inicial1/vocales.php?gradoB='.$_SESSION['grado'].'&curso=7';
}else{
  $linkVelocidad='../atomLector/velocidadLectora.php?gradoB='.$_SESSION['grado'].'&curso=7';
}
                 ...
                 <a href="<?php echo $linkVelocidad; ?>">
                   <div class="col-md-4">
                    <div class="card">
                      ...
                      <div class="text">
                        <h3>Práctica fonemas </h3>
                        <p style="text-align: left;">Estimulación temprana para el aprendizaje de escritura y lectura</p>
