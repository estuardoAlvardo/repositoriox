...
$sql2 = ("INSERT INTO registropruebacomprension4p(idLectura,idUsuario,tiempo,fechaRegistro,horaRegistro,rPregunta1,rPregunta2,rPregunta3,rPregunta4,rPregunta5,rPregunta6,rPregunta7,rPregunta8,rPregunta9,rPregunta10,rPregunta11, input1,input2,input3,input4,totalObtenido,intento) VALUES (:idLectura,:idUsuario,:tiempo,:fechaRegistro,:horaRegistro,:rPregunta1,:rPregunta2,:rPregunta3,:rPregunta4,:rPregunta5,:rPregunta6,:rPregunta7,:rPregunta8,:rPregunta9,:rPregunta10,:rPregunta11,:input1,:input2,:input3,:input4,:totalObtenido,:intento)");
$insertarQuiz4p = $dbConn->prepare($sql2);


//verificar intentos
$sql3=('SELECT * FROM registropruebacomprension4p where idLectura=:idLectura and idUsuario=:idUsuario');
...
foreach($_POST as $nombre_campo => $valor){ 
   ...
   if($nombre_campo=='idLecturaEnviado'){
      ...
      $insertarQuiz4p->bindParam(':idLectura',$_SESSION['idLectura_g'], PDO::PARAM_INT);
   }

   if($nombre_campo=='idUsuario'){
     $_SESSION['idUsuario_g']=$valor; 
     $insertarQuiz4p->bindParam(':idUsuario',$_SESSION['idUsuario_g'], PDO::PARAM_INT);

   }

   if($nombre_campo=='tiempo'){
    $_SESSION['tiempo_g']=$valor; 
     $insertarQuiz4p->bindParam(':tiempo', $_SESSION['tiempo_g'], PDO::PARAM_STR);

   }

   $insertarQuiz4p->bindParam(':fechaRegistro', $fecha_actual, PDO::PARAM_STR);
   $insertarQuiz4p->bindParam(':horaRegistro', $hora_actual, PDO::PARAM_STR);
  ...
  if(strpos($nombre_campo, 'multiple')!== false){
    ...
    //echo $insertar;
      ...
      if($insertar1=='rPregunta1'){
        ...
        $_SESSION['oki1']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['oki1'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta2'){
         $_SESSION['new1']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['new1'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta3'){
        $_SESSION['lem1']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['lem1'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta6'){
        $_SESSION['almacenar6']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['almacenar6'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta7'){
        $_SESSION['almacenar7']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['almacenar7'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta8'){
        $_SESSION['almacenar8']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['almacenar8'], PDO::PARAM_INT);
       ...
       if($insertar1=='rPregunta9'){
        $_SESSION['almacenar9']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['almacenar9'], PDO::PARAM_INT);
      ...
      if($insertar1=='rPregunta10'){
        $_SESSION['almacenar10']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['almacenar10'], PDO::PARAM_INT);
         //echo 'pregunta= '.$insertar1.' respuesta= '.$_SESSION['almacenar9'].'<br>';
       ...
       if($insertar1=='rPregunta11'){
        $_SESSION['almacenar11']=$valor;
         $insertarQuiz4p->bindParam($insertar1, $_SESSION['almacenar11'], PDO::PARAM_INT);
         //echo 'pregunta= '.$insertar1.' respuesta= '.$_SESSION['almacenar9'].'<br>';
   ...
   //echo $insertar;
    ...
    echo 'pregunta '.$insertar.'-----Respuesta ya comparada---'.$_SESSION['almacenarIn'.$o].'<br>';
     ...
     $insertarQuiz4p->bindParam(':intento', $hayIntentos, PDO::PARAM_INT);

   }

   }
   echo @$sumaCorrectas;
   $insertarQuiz4p->bindParam(':totalObtenido', @$sumaCorrectas, PDO::PARAM_INT);

$insertarQuiz4p->execute();
header("location:../resultadoCnb4p.php?idLectura=".$_POST['idLecturaEnviado']."&idUsuario=".$_POST['idUsuario'].'&gradoB='.$_POST['gradoB']);
