      ...
      <div class="col-md-8 col-xs-8 pag-center">
         ...
         <div class="col-md-12" style="">
          ...
          if(@$i>@$semanaPrueba){
              ...
              <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=m1" style="<?php echo $estiloActivo; ?>">
                ...
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                  ...
                  background-image: url('../img/l1.png'); background-size: 100%; background-repeat:no-repeat;">
                                  
                  </div>

                  <div class="col-md-7" style=" min-height: 175px; color: black;">
                    <h4 style="text-align: left;">Ensayo A</h4>
                    <h5 style="text-align: left;">Matemáticas</h5>
                    <h5 style="text-align: left;">Prueba Graduandos</h5>
                    <h5 style="text-align: left;"></h5>
                  


                    <span style="margin-left:50px; margin-top: 100px;" class="<?php echo $activoOjo; ?>"></span> 
                    <img id="<?php echo 'envi1'.$row1['idLectura']; ?>" src="enviado1.png" style="width: 40px; height: 40px; position:absolute; margin-top:80px; margin-left:10%;">
                 
                    <img id="<?php echo 'lei1'.$row1['idLectura']; ?>" src="leido1.png" style=" display:none; width: 40px; height: 40px; position:absolute; margin-top: 80px; margin-left:68%;">
             ...
             <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=m2" style="<?php echo $estiloActivo; ?>">
                <div class="col-md-5 estiloProducto" style="min-height:220px; margin-bottom: 20px; background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">

                  <div class="col-md-5" style=" min-height:175px; 
                  background-image: url('../img/l2.png'); background-size: 100%; background-repeat:no-repeat;">
                                  
                  </div>

                  <div class="col-md-7" style=" min-height: 175px; color: black;">
                    <h4 style="text-align: left;">Ensayo B</h4>
                    <h5 style="text-align: left;">Matemáticas</h5>
                    <h5 style="text-align: left;">Prueba Graduandos</h5>
                    <h5 style="text-align: left;"></h5>
              ...
              <div class="col-md-1"></div>
             <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=m3" style="<?php echo $estiloActivo; ?>">
                <div class="col-md-5 estiloProducto" style="min-height:220px; margin-bottom: 20px; background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">

                  <div class="col-md-5" style=" min-height:175px; 
                  background-image: url('../img/l3.png'); background-size: 100%; background-repeat:no-repeat;">
                                  
                  </div>

                  <div class="col-md-7" style=" min-height: 175px; color: black;">
                    <h4 style="text-align: left;">Ensayo C</h4>
                    <h5 style="text-align: left;">Matemáticas</h5>
                    <h5 style="text-align: left;">Prueba Graduandos</h5>
                    <h5 style="text-align: left;"></h5>
                ...
                <div class="col-md-1"></div>
             <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=m4"style="<?php echo $estiloActivo; ?>">
                <div class="col-md-5 estiloProducto" style="min-height:220px; margin-bottom: 20px; background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">

                  <div class="col-md-5" style=" min-height:175px; 
                  background-image: url('../img/l4.png'); background-size: 100%; background-repeat:no-repeat;">
                                  
                  </div>

                  <div class="col-md-7" style=" min-height: 175px; color: black;">
                    <h4 style="text-align: left;">Ensayo D</h4>
                    <h5 style="text-align: left;">Matemáticas</h5>
                    <h5 style="text-align: left;">Prueba Graduandos</h5>
                    <h5 style="text-align: left;"></h5>
