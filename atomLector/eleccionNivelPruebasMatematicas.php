  ...
  color: #36abcb;
         ...
         <div class="col-md-12" style="margin-top: 100px;">
              <h3 class="text-center" style=""><?php
               if($_GET['curso']==7){
                echo $_SESSION['curso']="Átomo Lector - Ensayos Matemáticas MINEDUC";
              }?></h3>
         </div>
...
<div class="col-md-11" style="margin-bottom: 100px;"><br><br>
  ...
  <div class="row" style="padding-left: 40px;">
    ...
    <a href="ensayosMatematicas.php?gradoB=10" style="color: white; <?php echo $diver1; ?>"> <div class="col-md-2 btnGrado" >4to Diver</div></a>
    <div class="col-md-1"></div>
     <a href="ensayosMatematicas.php?gradoB=11" style="color: white; <?php echo $diver2; ?>"><div class="col-md-2 btnGrado" style="">5to Diver</div></a>
    <div class="col-md-1"></div>
