                       ...
                       <td><strong><?php echo $rowr2['nombre'].' '.$rowr2['apellido']; ?></strong></td>  
                        <td><strong><?php echo $semana; ?></strong></td>   
                          ...
                          $buscarInCnb= ("SELECT * FROM registropruebacomprension JOIN cuestionario on registropruebacomprension.idLectura=cuestionario.idLectura where registropruebacomprension.idUsuario=:idUsuario and registropruebacomprension.intento=1 and cuestionario.fundamento='cnb' and registropruebacomprension.idLectura=:idLectura and registropruebacomprension.nivelObtenido is null limit 1 ");
                            ...
                            if($gradoReporte==3){
                               $buscarInCnb= ("SELECT * FROM registropruebacomprension3p JOIN cuestionario on registropruebacomprension3p.idLectura=cuestionario.idLectura where registropruebacomprension3p.idUsuario=:idUsuario and registropruebacomprension3p.intento=1 and cuestionario.fundamento='cnb' and registropruebacomprension3p.idLectura=:idLectura and nivelObtenido is not null limit 1");
                               $buscarCnb=$dbConn->prepare($buscarInCnb);
                                  $buscarCnb->bindParam(':idLectura',$_SESSION['idLectura'], PDO::PARAM_INT);
                                  $buscarCnb->bindParam(':idUsuario',$rowr2['idUsuario'], PDO::PARAM_INT);
                                   $buscarCnb->execute(); 
                            ...
                            if($gradoReporte==4){
                               $buscarInCnb= ("SELECT * FROM registropruebacomprension4p JOIN cuestionario on registropruebacomprension4p.idLectura=cuestionario.idLectura where registropruebacomprension4p.idUsuario=:idUsuario and registropruebacomprension4p.intento=1 and cuestionario.fundamento='cnb' and registropruebacomprension4p.idLectura=:idLectura and registropruebacomprension4p.nivelObtenido  is null limit 1");
                               $buscarCnb=$dbConn->prepare($buscarInCnb);
                                  $buscarCnb->bindParam(':idLectura',$_SESSION['idLectura'], PDO::PARAM_INT);
                                  $buscarCnb->bindParam(':idUsuario',$rowr2['idUsuario'], PDO::PARAM_INT);
                                   $buscarCnb->execute(); 
                             ...
                             if($gradoReporte==5){
                               $buscarInCnb= ("SELECT * FROM registropruebacomprension5p JOIN cuestionario on registropruebacomprension5p.idLectura=cuestionario.idLectura where registropruebacomprension5p.idUsuario=:idUsuario and registropruebacomprension5p.intento=1 and cuestionario.fundamento='cnb' and registropruebacomprension5p.idLectura=:idLectura and registropruebacomprension5p.nivelObtenido= null limit 1");
                               $buscarCnb=$dbConn->prepare($buscarInCnb);
                                  $buscarCnb->bindParam(':idLectura',$_SESSION['idLectura'], PDO::PARAM_INT);
                                  $buscarCnb->bindParam(':idUsuario',$rowr2['idUsuario'], PDO::PARAM_INT);
                                   $buscarCnb->execute(); 
                            ...
                            if($gradoReporte>=6 and $gradoReporte<=11){
                               $buscarInCnb= ("SELECT * FROM registropruebacomprension6p JOIN cuestionario on registropruebacomprension6p.idLectura=cuestionario.idLectura where registropruebacomprension6p.idUsuario=:idUsuario and registropruebacomprension6p.intento=1 and cuestionario.fundamento='cnb' and registropruebacomprension6p.idLectura=:idLectura and registropruebacomprension6p.nivelObtenido= null limit 1");
                               $buscarCnb=$dbConn->prepare($buscarInCnb);
                                  $buscarCnb->bindParam(':idLectura',$_SESSION['idLectura'], PDO::PARAM_INT);
                                  $buscarCnb->bindParam(':idUsuario',$rowr2['idUsuario'], PDO::PARAM_INT);
                                   $buscarCnb->execute(); 
                          ...
                          <td>
                           ...
                           //consulta para ver cuantas palabras lleva
                              ...
                              if($totalRegistro>=1){
                                ...
                                $porcentajeDiv=100/$totalPalabras;
                               $porcentajeRealizado=$porcentajeDiv*$totalRegistro;

                               echo round($porcentajeRealizado).'%';
