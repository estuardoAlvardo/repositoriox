...
if($_SESSION['grado']>=13 and $_SESSION['grado']<=15){
  $linReenviarV='../atomLector/inicial1/vocales.php?gradoB='.$_SESSION['grado'].'&curso=7';
}else{
 $linReenviarV='../atomLector/velocidadLectora.php?gradoB='.$_SESSION['grado'].'&curso=7';
...
$("i").click(function() {
      ...
      <div class="col-md-8 col-xs-8 pag-center">
         <div class="col-md-12" style="">
            ...
            <div class="row">
           <?php if($_SESSION['grado']>=13 and $_SESSION['grado']<=15 or $_SESSION['grado']>=1 and $_SESSION['grado']<=3){}else{ ?>
