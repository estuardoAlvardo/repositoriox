...
<h4 style="margin-left: 50%;">Actividades</h4>
 ...
 <a href="lecturaDiariaJuego.php?idLectura=<?php echo $_SESSION['gradoEnviar']; ?>&gradoB=<?php echo $_GET['gradoB']; ?>" class="btn btn-default botonAgg-1" style="background-color: #e67e22; border:1px solid #e67e22; color:white; ">Juego</a><br><br>
...
<?php } ?>
               ...
               <a href="<?php echo '../lecturasDiarias.php?gradoB='.$_GET['gradoB']; ?>" class="btn btn-default botonAgg-1" style="background-color: #e67e22; border:1px solid #e67e22; color:white; ">volver a las lecturas diarias</a>
               <p style="text-align: center; margin-top: 10px;">Instrucciones: Puedes cambiar de página útilizando las teclas de izquierda y derecha, si quieres hacer zoom en la lectura debes de dar clic en la parte del texto a observar.</p>
               <hr>
...
<!--- datos para enviar de prescolar-->
<?php $fecha_actual=date("d/m/Y");
$hora_actual=date('h:i:s'); ?>

<form style="display:none;" id="formularioDiariasPresco" method="post" action="controllador/lecturasDiariasPresco.php">
  <input type="text" name="fecha" value="<?php echo $fecha_actual; ?>">
  <input type="text" name="hora" value="<?php echo $hora_actual; ?>">
  <input type="text" name="idLectura" value="<?php echo $_GET['idLectura']; ?>">
  <input type="text" name="grado" value="<?php echo $_GET['gradoB']; ?>">
  <input type="submit" name="" value="enviar datos lecturas presco">
</form>


<script>
var aud = document.getElementById("audio");
var formulario=$('#formularioDiariasPresco');
