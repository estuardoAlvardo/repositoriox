...
$noSemanaActual=$noSemanaActual-5;
         ...
         <div class="col-md-12" style="">
            ...
            <h3 class="text-left" style="">Lecturas y Evaluaciones</h3><hr>
             ...
             <div class="row">
                  ...
                  <a href="../atomLector/eleccionNivelPruebasLenguaje.php?curso=7">
                   <div class="col-md-4">
                    <div class="card">

                      <div class="image" >
                        <img  src="../img/graduandos1.png" width="60%">
                      </div>

                      <div class="text">
                        <h3>Ensayos Lenguaje</h3>
                        <p style="text-align: left;">Entrenamiento para graduandos, pruebas lenguaje ministerio de educación.</p>
                      ...
                      <div class="md-chip indigo">
                          ...
                          <span class="md-chip-text">Vamos a entrenar </span>
                        </div>
                 ...
                 <a href="../atomLector/eleccionNivelPruebasMatematicas.php?curso=7">
                   <div class="col-md-4">
                    <div class="card">

                      <div class="image" >
                        <img  src="../img/graduandos2.png" width="60%">
                      </div>

                      <div class="text">
                        <h3>Ensayos Matemáticas</h3>
                        <p style="text-align: left;">Entrenamiento para graduandos, pruebas lenguaje ministerio de educación.</p>
