...
-->
 ...
 ---> 
          ...
          <h5 style="color: white; margin-left: 20px;" class="text-left">Reportes<br>Lecturas</h5>
...
-->
          <a href="../apps/planificacion.php"><img class="img-responsive" src="../img/planificacion.png" style="max-width: 50px; max-height: 50px; margin-left: 65%; margin-top: -60%;" title="Plani"/>           
          </a>
          <h5 style="color: white; margin-left: 60%;" class="text-left" >Reportes Pruebas</h5>
          <!--
          <a href="../apps/streamingCanales.php"><img class="img-responsive" src="../img/streaming.png" style="max-width: 50px; max-height: 50px; margin-left: 65%; margin-top: -50%; " />           
          </a>
