...
body {
  ...
  font-family: "Calibri", "Roboto", sans-serif;
         ...
         <div class="col-md-12" style=" margin-bottom: 50px;">
              <h3 class="text-center">Crear Canal de Trasnmisión</h3>
         </div>
         ...
         <div class="col-md-12 sombra" style=" min-height: 500px; margin-bottom: 50px; ">
          ...
          <form action="streaming.php" method="post">
            <input type="text" class="form-control" name="nombreCana" placeholder="Ingrese el Nombre de la Trasnmisión"><br>
            <input type="text" class="form-control" name="nombreCana" placeholder="Descripcion de la Transmisión"><br>
             <input class="btn botonAgg botonAgg-1" type="submit" value="Crear Canal"  style="background-color: rgb(54, 171, 203); color: white; border:white; float: right; ">
          </form>  
