      ...
      <div class="col-md-8 col-xs-8 pag-center">
         ...
         <div class="col-md-12" style="">
          ...
          if(@$i>@$semanaPrueba){
              ...
              <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=l1" style="<?php echo $estiloActivo; ?>">
                ...
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                  ...
                  <div class="col-md-7" style=" min-height: 175px; color: black;">
                    ...
                    <h5 style="text-align: left;">Lenguaje</h5>
             ...
             <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=l2" style="<?php echo $estiloActivo; ?>">
                <div class="col-md-5 estiloProducto" style="min-height:220px; margin-bottom: 20px; background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
              ...
              <div class="col-md-1"></div>
             <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=l3" style="<?php echo $estiloActivo; ?>">
                <div class="col-md-5 estiloProducto" style="min-height:220px; margin-bottom: 20px; background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                ...
                <div class="col-md-1"></div>
             <a href="p1/ensayo.php?gradoB=<?php echo $_GET['gradoB']; ?>&ensayo=l4"style="<?php echo $estiloActivo; ?>">
                <div class="col-md-5 estiloProducto" style="min-height:220px; margin-bottom: 20px; background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
                <div class="row" style="background-image: linear-gradient(to top, #e6e9f0 0%, #eef1f5 100%);">
