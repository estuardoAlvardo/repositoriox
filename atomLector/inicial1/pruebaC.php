...
<div class="card col-md-12">
  <div style="display: inline-block; border: 3px solid white; border-radius: 20rem; color: white; text-align: center; padding: 0.5rem; box-shadow: rgba(0, 0, 0, 0.15) 0px 1px 3px 0px; font-weight: 600; min-width: 4rem; font-size: 2rem; background-color: rgb(54, 171, 203); position: absolute; margin-top: 25%; margin-left: 90%;" ><?php echo @$noPregunta; ?></div>
  <h1 style="text-align: center; background-color: #3498db;color:white;" id="<?php echo 'preg'.$noPregunta; ?>" onclick="leerPregunta(this.id)" class="card"><?php echo "Pregunta no.".$noPregunta.": ".$row1['pregunta']; ?></h1>
  
  <ul>
    <li >
      <input value="1" type="radio" name="<?php echo 'name'.$noPregunta; ?>" id="one" style="" />
      <label style="" ><?php echo $row1['respuesta1']; ?></label>
